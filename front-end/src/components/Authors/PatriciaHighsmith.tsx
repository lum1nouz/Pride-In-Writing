            ...
            <div style={{}}>
              ...
              <Paper elevation={4} className={css.paperCont}>
                ...
                <div style={{ textAlign: "center" }}>
                  ...
                  <p>
                    Born in Fort Worth, Texas, Patricia Highsmith was an
                    American novelist known for her psychological thrillers and
                    romances.
                  </p>

                  <h2>Books</h2>
                  <p>
                    <Button component={Link} to="/the-price-of-salt">
                  ...
                  <h2>Publishers</h2>
                  <p>
                    <Button component={Link} to="/putnam">
                      G. P. Putnam's Sons
                    </Button>
                  </p>
                </div>
