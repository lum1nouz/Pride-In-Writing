                    ...
                    <Grid container spacing={1}>
                      ...
                      <Grid item xs={4}>
                        <div style={{ margin: 10 }}>
                          ...
                          <TextField
                            ...
                            variant="outlined"
                            onChange={(e) =>
                              this.handleFilterChange("origin", e)
                            }
                            onKeyPress={(e) => this.handleEnterKey(e)}
                          >
                            {" "}
                      ...
                      <Grid item xs={4}>
                        <div style={{ margin: 10 }}>
                          ...
                          <Select
                            ...
                            label="Age"
                            onChange={(e) =>
                              this.handleSelectFilter(e, "publication_types")
                            }
                          >
                      ...
                      <Grid item xs={4}>
                        <div style={{ margin: 10 }}>
                          ...
                          <TextField
                            label="Filter by Authors Published"
                            variant="outlined"
                            onChange={(e) =>
                              this.handleFilterChange("author_connections", e)
                            }
                            onKeyPress={(e) => this.handleEnterKey(e)}
                          >
                            {" "}
                      ...
                      <Grid item xs={4}>
                        <div style={{ margin: 10 }}>
                          ...
                          <TextField
                            label="Filter by Year Founded"
                            variant="outlined"
                            onChange={(e) =>
                              this.handleFilterChange("founded", e)
                            }
                            onKeyPress={(e) => this.handleEnterKey(e)}
                          >
                            {" "}
                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          <th scope="col">
                            {this.highlightText("Country of Origin")}
                          </th>
                          <th scope="col">
                            {this.highlightText("Publication Types")}
                          </th>
                          <th scope="col">
                            {this.highlightText("Authors Published")}
                          </th>
                          <th scope="col">
                            {this.highlightText("Year Founded")}
                          </th>
                        </tr>
                      </thead>
                      <tbody>
