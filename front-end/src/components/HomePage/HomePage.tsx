            ...
            >
              <div className="pride" data-testid="pride">
                ...
                <div className="mission">
                  <p>
                    Our mission is to spotlight books, authors, and publishers
                ...
                <Card sx={{ maxWidth: 345 }}>
                  <CardActionArea>
                    ...
                    <CardContent>
                      ...
                      <Typography variant="body2">
                        Learn which Publishing companies are supporting LGBTQ
                        Authors!
                      </Typography>
                    </CardContent>
                  </CardActionArea>
            ...
            <Grid container spacing={2} style={{ position: "relative" }}>
              ...
              >
                ...
                <p style={{ color: "white", fontWeight: "normal" }}>
                  Our mission is to spotlight books, authors, and publishers in
                  the LGBTQ Community
                </p>
              </Grid>
