    ...
    return (
      <div>
           ...
           <Legend payload={
            ...
            >
              {this.state.pubData.map((val, index) => (
                <Cell key={`cell-${val.count}`} fill={this.COLORS[index % this.COLORS.length]}/>
              ))}
            </Pie>
          </PieChart>
        </ResponsiveContainer>
        ...
        >     
          ...
          <Scatter name="Rating by Book" data={this.state.bookData} fill="#8884d8">
          </Scatter>
              </ScatterChart>
        </div>
        </ResponsiveContainer>
